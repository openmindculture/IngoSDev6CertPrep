...
A discontinued feature branch for certification preparation contains steps towards a maximalist full-on example of what could be done using plugins, inspired by the original Shopware Academy training videos (see [tag 0.1.1](https://github.com/openmindculture/IngoSDev6CertPrep/releases/tag/0.1.1)).
